...
const api = axios.create({
  baseURL: 'https://qaran.onrender.com/api',  // baseURL already has /api
  headers: {
...
export const fetchProducts = createAsyncThunk(
  ...
  async (params, { rejectWithValue }) => {
    try {
      const response = await api.get('/products', { params }); // ✅ Correct
...
export const fetchCategories = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await api.get('/products/categories'); // ✅ Correct
      return response.data;
    } catch (error) {
      return rejectWithValue(error.message);
    }
...
export const fetchFeatured = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await api.get('/products/featured'); // ✅ Correct
      return response.data;
    } catch (error) {
      return rejectWithValue(error.message);
    }
...
export const fetchSpecialOffers = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await api.get('/products/offers'); // ✅ Correct
      return response.data;
    } catch (error) {
      return rejectWithValue(error.message);
    }
